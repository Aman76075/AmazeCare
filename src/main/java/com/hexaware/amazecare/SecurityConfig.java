	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf((csrf) -> csrf.disable())
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.POST,"/doctor/generateMedicalRecord/{did}").hasAuthority("DOCTOR")
						.requestMatchers(HttpMethod.POST,"/doctor/testnscans/{did}").hasAuthority("DOCTOR")
						.requestMatchers(HttpMethod.GET,"/medicalrecord/{id}").hasAnyAuthority("DOCTOR","IN_PATIENT","OUT_PATIENT")
